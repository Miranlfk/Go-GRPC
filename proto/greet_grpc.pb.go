...
type GreetServiceClient interface {
	...
	SayHelloServerStream(ctx context.Context, in *ListofNames, opts ...grpc.CallOption) (GreetService_SayHelloServerStreamClient, error)
...
func (c *greetServiceClient) SayHelloServerStream(ctx context.Context, in *ListofNames, opts ...grpc.CallOption) (GreetService_SayHelloServerStreamClient, error) {
...
func (x *greetServiceSayHelloClientStreamClient) CloseAndRecv() (*MessageResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
func (c *greetServiceClient) SayHelloBiDiStream(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBiDiStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/greet_service.GreetService/SayHelloBiDiStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceSayHelloBiDiStreamClient{stream}
	return x, nil
}
...
type greetServiceSayHelloBiDiStreamClient struct {
	grpc.ClientStream
}

func (x *greetServiceSayHelloBiDiStreamClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceSayHelloBiDiStreamClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	SayHelloServerStream(*ListofNames, GreetService_SayHelloServerStreamServer) error
...
func (UnimplementedGreetServiceServer) SayHelloServerStream(*ListofNames, GreetService_SayHelloServerStreamServer) error {
...
func (UnimplementedGreetServiceServer) SayHelloBiDiStream(GreetService_SayHelloBiDiStreamServer) error {
...
func (x *greetServiceSayHelloClientStreamServer) SendAndClose(m *MessageResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _GreetService_SayHelloBiDiStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBiDiStream(&greetServiceSayHelloBiDiStreamServer{stream})
}
...
type greetServiceSayHelloBiDiStreamServer struct {
	grpc.ServerStream
}

func (x *greetServiceSayHelloBiDiStreamServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceSayHelloBiDiStreamServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
